@if (count($errors) > 0)
    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
        <h2 class="mb-2 text-lg font-semibold  dark:text-white">¡Error!</h2>
...
<div class="grid gap-6 mb-6 md:grid-cols-2">
    ...
    <div>
        ...
        <input type="text" id="Apellidos" name="apellidos"
            value="{{ isset($personal->apellidos) ? $personal->apellidos : old('apellidos') }}"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div>
        ...
        <input type="text" id="dni" name="dni"
            value="{{ isset($personal->dni) ? $personal->dni : old('dni') }}"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="DNI">
    </div>
    ...
    <div>
        ...
        <input type="tel" id="celular" name="celular"
            value="{{ isset($personal->celular) ? $personal->celular : old('celular') }}"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="987654321" {{-- pattern="[0-9]{3}-[0-9]{3}-[0-9]{3}" --}}>
    </div>
    ...
    <div>
        ...
        <div class="relative max-w-sm">
            ...
            <input datepicker datepicker-format="mm/dd/yyyy" type="text"
                ...
                value="{{ isset($personal->fecha_nacimiento) ? $personal->fecha_nacimiento : old('fecha_nacimiento') }}" import Datepicker from 'flowbite-datepicker/Datepicker';
...
<div class="mb-12">
    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Cargar
        foto</label>
    @isset($personal->foto)
        <img class="rounded-lg w-28 h-28" src="{{ asset('storage') . '/' . $personal->foto }}" alt="image description">
    @endisset
    ...
    {{-- uploads/43BmRkmfBfAwF4xU8xAAWY9KDp2nyHiEMWKzDpza.jpg --}}
