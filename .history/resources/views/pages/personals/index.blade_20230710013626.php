        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                                ...
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    alt="image description"> --}}
                                        ...
                                        <img class="rounded-lg w-28 h-28"
                                            src="{{ asset('storage') . '/' . $personals->foto }}"
                                            alt="image description">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            {{-- {{ $personals->links('pagination::simple-tailwind') }}
                            {{ $personals->links('personals.index') }}

                            // Passing additional data to the view...
                            {{ $personals->links('personals.index', ['foo' => 'bar']) }} --}}
                ...
                {{-- <br>
                    ...
                    {{ $personals->links('pagination::semantic-ui') }} --}}
            </div>
        </div>
    </div>
</x-app-layout>
