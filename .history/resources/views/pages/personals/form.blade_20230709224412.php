...
<div class="grid gap-6 mb-6 md:grid-cols-2">
    ...
    <div>
        ...
        <input type="text" id="Apellidos" name="apellidos" value=" {{ old('apellidos', $personal->apellidos) }}"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div>
        ...
        <input type="text" id="dni" name="dni" value="{{ old('dni'), $personal->dni }}"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div>
        <label for="Celular" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nº de
            Celular</label>
        <input type="tel" id="celular" name="celular" value="{{ old('celular', $personal->celular) }}"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div>
        ...
        <input type="text" id="direccion" name="direccion" value="{{ isset($personal->direccion)?$personal->direccion:old('direccion') }}"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div>
        ...
        <input type="date" id="FechaNacimiento" name="fecha_nacimiento"
            value="{{ isset($personal->fecha_nacimiento)? }}"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    </div>
